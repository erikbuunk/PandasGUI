...
class FindToolbar(QtWidgets.QToolBar):
    ...
    def update_matches(self, cells_matched):
        ...
        Args:
            cells_matched: list of tuples - (row, col). Type QtCore.Signal(list).
        """
...
class ButtonLineEdit(QtWidgets.QLineEdit):
    ...
    def resizeEvent(self, event):
        ...
        right_margin = QGraphicsLayoutItem.getContentsMargins()[2]
        bottom_margin = QGraphicsLayoutItem.getContentsMargins()[3]
